...
Program Dependencies : iris.csv & module Iris4.py (written by me)

To run the program : python3 plotiris.py
      ...
      This program
           ...
           If the file exists a menu is displayed offering the following options
              ...
              2. View Iris stats using code that does not use python inbuilt packages,
                 i.e. data is loaded in to dicts and functions were written to calculate mean, median, range & mode
                 The code run here is imported as a separate module to keep this program clean looking.
